...
//=========================================================================
    ...
    //refresh otomatis setiap 8detik
    setInterval(Suara, 8000); 
    $(document).ready(function() {
        Suara();
    });
 ...
 //=======================================================================
    ...
    // Memanggil fungsi DisplayNomor() secara berkala (misalnya, setiap 2 detik)
    setInterval(DisplayNomor, 2000);
...
// Menjalankan displaypoli() setiap 5000 milidetik (5 detik)
setInterval(datapoli, 5000);
